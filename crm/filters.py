...
class CustomerFilter(django_filters.FilterSet):  # Changed from FilterSet to django_filters.FilterSet
    # Basic text filters
...
class ProductFilter(django_filters.FilterSet):  # Changed from FilterSet to django_filters.FilterSet
    # Text filters
...
class OrderFilter(django_filters.FilterSet):  # Changed from FilterSet to django_filters.FilterSet
